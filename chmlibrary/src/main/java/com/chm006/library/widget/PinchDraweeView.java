 ...
 * @author clifford
 */
public class PinchDraweeView extends ImageView {
    ...
    public PinchDraweeView(Context context) {
        super(context);
        initView();
    }

    public PinchDraweeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinchDraweeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    //点击，双击，长按，滑动等手势处理
    private GestureDetector mGestureDetector = new GestureDetector(PinchDraweeView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(PinchDraweeView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mOnClickListener != null) {
                mOnClickListener.onClick(PinchDraweeView.this);
            }
            return true;
        }
    });
